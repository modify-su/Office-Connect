        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4" id="leave-stats-row">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-100 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-semibold text-slate-400">อยู่ระหว่างทดสอบ/รอรีวิว</p>
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-100 grid grid-cols-1 md:grid-cols-4 gap-4" id="leave-filters-bar">
            ...
            <div>
              ...
              >
                <option value="All">ทุกสถานะใบรับรอง</option>
                <option value="pending">⏳ ตรวจสอบ/รออนุมัติ</option>
                <option value="approved">✅ อนุมัติผ่านเกณฑ์</option>
                    ...
                    <div className="flex flex-col sm:flex-row md:flex-col items-start sm:items-center md:items-end gap-3 w-full md:w-auto md:self-stretch justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`inline-flex items-center gap-1 text-xs font-bold px-3 py-1 rounded-full ${
                          ...
                          {req.status === 'approved' ? 'อนุมัติแล้ว' : req.status === 'pending' ? 'รอพิจารณา' : 'ไม่อนุมัติ'}
                        </span>
                      </div>
                      ...
                      {req.status === 'pending' && !isEmployee && (
                        <div className="flex items-center gap-2 w-full sm:w-auto" id={`leave-actions-${req.id}`}>
                          <button
                            ...
                            className="flex-1 sm:flex-none flex items-center justify-center gap-1 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-medium px-3 py-1.5 rounded-lg transition border border-emerald-600 cursor-pointer"
                          >
